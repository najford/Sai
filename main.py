...
__CHANNEL_USERNAME__ = "BOSS IAN"
__GROUP_USERNAME__   = "BOSS IAN"
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @No Speed Limit ')) 
